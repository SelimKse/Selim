...
video.addEventListener("ended", () => {
  setTimeout(() => {
    alert("İndirme Başlatıld... Kafan karışırsa bana yaz :)")
...
video.addEventListener("ended", function () {
  var fileUrl = "http://busra-selim.tech/dist/QR.apk"; // Örnek dosya yolu, uygun şekilde değiştirin
  var link = document.createElement("a");
  link.href = fileUrl;
  link.download = "QR.apk"; // İndirilecek dosyanın adını belirleyin
